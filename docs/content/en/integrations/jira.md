...
By default Defect Dojo uses the `dojo/templates/issue-trackers/jira/jira_full/jira-description.tpl` template to render the description of the 'to be' created JIRA issue.
