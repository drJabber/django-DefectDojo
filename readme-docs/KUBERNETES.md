...
The `site_url` in values.yaml controls what domain is configured in Django, and also what the celery workers will put as links in Jira/OpenProject tickets for example.
