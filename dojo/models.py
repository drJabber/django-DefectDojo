...
class OpenProject_Instance(models.Model):
    configuration_name = models.CharField(max_length=2000, help_text=_("Enter a name to give to this configuration"), default='')
    url = models.URLField(max_length=2000, verbose_name=_('OpenProject URL'), help_text=_("For more information how to configure OpenProject, read the DefectDojo documentation."))
    username = models.CharField(max_length=2000)
    password = models.CharField(max_length=2000)

    if hasattr(settings, 'OPENPROJECT_ISSUE_TYPE_CHOICES_CONFIG'):
        default_issue_type_choices = settings.OPENPROJECT_ISSUE_TYPE_CHOICES_CONFIG
    else:
        default_issue_type_choices = (
                                        ('Task', 'Task'),
                                        ('Milestone', 'Milestone'),
